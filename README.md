...
2. [Solana-verifier](https://github.com/adamsmo/solana-proof-generator) — on-chain verifier code for ZK-shielded-pool, built by [adamsmo](https://github.com/adamsmo).
